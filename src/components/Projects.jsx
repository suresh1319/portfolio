  ...
  const projects = [
    {
      id: 1,
      title: 'SnapStudy',
      description: 'An AI-powered application that helps students generate comprehensive study materials from various sources. Upload documents, provide links, or input text to automatically generate notes, summaries, flashcards, quizzes, and more.',
      image: snapStudy,
      category: 'app',
      technologies: ['React.js', 'Node.js', 'Express.js', 'Tailwind CSS', 'Firebase', 'AI Integration'],
      demoLink: '#',
      codeLink: 'https://github.com/suresh1319/ai-summarizer',
    },
    {
      id: 2,
      title: 'Pure Care Fitness',
      description: 'A full-stack fitness management web application that connects users with fitness trainers and local gyms. The platform provides real-time chat, user authentication, service listings, and reviews.',
    ...
    },
    {
      ...
      description: 'A full-stack web application using the MERN stack that generates images via Stability AI\'s API. Enables users to create, share, search, and download AI-generated images.',
      image: imageGenerator,
      category: 'app',
      technologies: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'Cloudinary'],
      demoLink: '#',
      codeLink: 'https://github.com/suresh1319/IMAGE_GENERATIOR',
    },
  ];
            ...
            <div key={project.id} className="project-card" data-aos="fade-up">
              ...
              <div className="project-info">
                ...
                <div className="project-links">
                  ...
                  <a href={project.codeLink} target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-outline">
                    View Code
                  </a>
                </div>
              </div>
